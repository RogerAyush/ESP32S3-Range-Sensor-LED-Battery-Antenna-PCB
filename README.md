...
- **Tools Used**: Designed in **Altium Designer** (schematic dated **10-01-2025**). SPICE simulations verified charger current ($I_{CHG} = 1000/2.4k \approx 417 \text{ mA}$) and switching behavior.
...
Here are the renders of the 4-layer PCB design and a 3D model of the assembled board.

**Top Layer View**
*The top layer is densely populated with the main components, including the ESP32-S3, camera/ToF connectors, USB-C port, and power management ICs.*
<img width="1407" height="430" alt="image" src="https://github.com/user-attachments/assets/791b23ed-8f07-4000-b8ff-cf23151f89c5" />
...
**Inner Layers (Power & Ground)**
*The inner layers consist of a dedicated ground plane and a power plane to ensure signal integrity and proper power distribution.*
<img width="1406" height="448" alt="image" src="https://github.com/user-attachments/assets/e9fe2d2c-ed0e-4a4b-8b04-e0bd6dac95ea" />
...
![Print_page-0001](https://github.com/user-attachments/assets/11fa4ed0-b124-49dd-9c4d-05540e50654c)
